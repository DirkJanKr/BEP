...
#  # description: Devices_project_template MCXN947
#  set(CONFIG_USE_DEVICES_Project_Template_MCXN947 true)

#  # description: Device MCXN947_startup
#  set(CONFIG_USE_device_MCXN947_startup true)

#  # description: Device MCXN947_system
#  set(CONFIG_USE_device_MCXN947_system true)

#  # description: Device MCXN947_cmsis
...
#  # description: TDET Driver
#  set(CONFIG_USE_driver_tdet true)
...
#  set(CONFIG_USE_driver_opamp true)
...
#  # description: ROMAPI Driver
#  set(CONFIG_USE_driver_runbootloader true)

#  # description: MCX ENET Driver
...
#  # description: INTM Driver
#  set(CONFIG_USE_driver_intm true)
...
#  # description: DAC14 Driver
#  set(CONFIG_USE_driver_dac14 true)
...
#  set(CONFIG_USE_driver_cache_lpcac true)
...
#  # description: mflash mcxnx4x
#  set(CONFIG_USE_component_mflash_mcxnx4x_onchip true)

#  # description: mflash mcxnx4x
#  set(CONFIG_USE_component_mflash_mcxnx4x_onchip_fmu true)

#  # description: mflash mcxnx4x_flexspi
#  set(CONFIG_USE_component_mflash_mcxnx4x_flexspi true)
...
#  # description: BOARD_Project_Template mcxn9xxevk_om13790host
#  set(CONFIG_USE_BOARD_Project_Template_mcxn9xxevk_om13790host true)

#  # description: BOARD_Project_Template mcxn9xxevk_a8974
#  set(CONFIG_USE_BOARD_Project_Template_mcxn9xxevk_a8974 true)

#  # description: BOARD_Project_Template frdmmcxn947_om13790host
#  set(CONFIG_USE_BOARD_Project_Template_frdmmcxn947_om13790host true)
...
#  # description: RPMsg-Lite for mcxnx10 baremetal application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_mcxnx4x_bm true)

#  # description: RPMsg-Lite for mcxnx10 FreeRTOS application
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_mcxnx4x_freertos true)

#  # description: RPMsg-Lite baremetal for mcxnx10 boards
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_bm_config_mcxnx4x true)

#  # description: RPMsg-Lite FreeRTOS for mcxnx10 boards
#  set(CONFIG_USE_middleware_multicore_rpmsg_lite_freertos_config_mcxnx4x true)

#  # description: MCMgr
#  set(CONFIG_USE_middleware_multicore_mcmgr true)

#  # description: Multicore Manager for MCX NX4X board
...
#  # description: Component els_pkc.doc.mcxn
#  set(CONFIG_USE_component_els_pkc_doc_mcxn true)

#  # description: Component els_pkc static_lib MCXN
...
#  # description: Component els_pkc_mcxn
...
#  # description: ISSDK GPIO Driver for MCX
#  set(CONFIG_USE_middleware_issdk_drivers_gpio_mcx true)
...
#  # description: PMSM sensorless control for eflexpwm, adcncxn and quadrature decoder based MCUs
#  set(CONFIG_USE_middleware_motor_control_mc_drivers_adcncxn_pwma_enc true)
...
include_if_use(BOARD_Project_Template_frdmmcxn947)
include_if_use(BOARD_Project_Template_frdmmcxn947_a8974.MCXN947)
include_if_use(BOARD_Project_Template_frdmmcxn947_om13790host.MCXN947)
include_if_use(BOARD_Project_Template_mcxn9xxevk)
include_if_use(BOARD_Project_Template_mcxn9xxevk_a8974.MCXN947)
include_if_use(BOARD_Project_Template_mcxn9xxevk_om13790host.MCXN947)
...
include_if_use(DEVICES_Project_Template_MCXN947.MCXN947)
include_if_use(RTE_Device.MCXN947)
include_if_use(component_audio_sai_edma_adapter.MCXN947)
include_if_use(component_button.MCXN947)
include_if_use(component_codec_adapters.MCXN947)
include_if_use(component_codec_i2c.MCXN947)
include_if_use(component_common_task)
include_if_use(component_crc_adapter.MCXN947)
include_if_use(component_cs42888_adapter.MCXN947)
include_if_use(component_ctimer_adapter.MCXN947)
include_if_use(component_da7212_adapter.MCXN947)
...
include_if_use(component_els_pkc_doc_mcxn)
...
include_if_use(component_els_pkc_platform_mcxn)
...
include_if_use(component_els_pkc_standalone_keyManagement)
include_if_use(component_els_pkc_static_lib_mcxn)
...
include_if_use(component_gpio_adapter.MCXN947)
include_if_use(component_i3c_adapter.MCXN947)
include_if_use(component_i3c_bus.MCXN947)
include_if_use(component_i3c_bus_adapter.MCXN947)
include_if_use(component_led.MCXN947)
include_if_use(component_lists.MCXN947)
include_if_use(component_log.MCXN947)
include_if_use(component_log_backend_debugconsole.MCXN947)
include_if_use(component_log_backend_debugconsole_lite.MCXN947)
include_if_use(component_log_backend_ringbuffer.MCXN947)
include_if_use(component_lpi2c_adapter.MCXN947)
include_if_use(component_lpspi_adapter.MCXN947)
include_if_use(component_lptmr_adapter.MCXN947)
include_if_use(component_lpuart_adapter.MCXN947)
include_if_use(component_lpuart_dma_adapter.MCXN947)
include_if_use(component_mem_manager.MCXN947)
include_if_use(component_mem_manager_light.MCXN947)
include_if_use(component_mflash_common.MCXN947)
include_if_use(component_mflash_dummy.MCXN947)
include_if_use(component_mflash_file.MCXN947)
include_if_use(component_mflash_mcxnx4x_flexspi.MCXN947)
include_if_use(component_mflash_mcxnx4x_onchip.MCXN947)
include_if_use(component_mflash_mcxnx4x_onchip_fmu.MCXN947)
include_if_use(component_mrt_adapter.MCXN947)
...
include_if_use(component_ostimer_adapter.MCXN947)
include_if_use(component_panic.MCXN947)
include_if_use(component_pwm_ctimer_adapter.MCXN947)
include_if_use(component_reset_adapter.MCXN947)
include_if_use(component_serial_manager.MCXN947)
include_if_use(component_serial_manager_spi.MCXN947)
include_if_use(component_serial_manager_swo.MCXN947)
include_if_use(component_serial_manager_uart.MCXN947)
include_if_use(component_serial_manager_usb_cdc.MCXN947)
include_if_use(component_serial_manager_virtual.MCXN947)
include_if_use(component_sgtl_adapter.MCXN947)
include_if_use(component_silicon_id.MCXN947)
include_if_use(component_software_crc_adapter.MCXN947)
include_if_use(component_software_rng_adapter.MCXN947)
include_if_use(component_timer_manager.MCXN947)
include_if_use(component_wifi_bt_module_config.MCXN947)
include_if_use(component_wifi_bt_module_tx_pwr_limits.MCXN947)
include_if_use(component_wm8904_adapter.MCXN947)
include_if_use(component_wm8960_adapter.MCXN947)
include_if_use(device_MCXN947_CMSIS.MCXN947)
include_if_use(device_MCXN947_startup.MCXN947)
include_if_use(device_MCXN947_system.MCXN947)
include_if_use(driver_cache_cache64.MCXN947)
include_if_use(driver_cache_lpcac.MCXN947)
include_if_use(driver_camera-common.MCXN947)
include_if_use(driver_camera-device-common.MCXN947)
include_if_use(driver_camera-device-ov7670.MCXN947)
include_if_use(driver_camera-device-sccb.MCXN947)
include_if_use(driver_camera-receiver-common.MCXN947)
include_if_use(driver_cdog.MCXN947)
include_if_use(driver_clock.MCXN947)
include_if_use(driver_cmsis_lpi2c.MCXN947)
include_if_use(driver_cmsis_lpspi.MCXN947)
include_if_use(driver_cmsis_lpuart.MCXN947)
include_if_use(driver_codec.MCXN947)
include_if_use(driver_common.MCXN947)
include_if_use(driver_crc.MCXN947)
include_if_use(driver_cs42888.MCXN947)
include_if_use(driver_ctimer.MCXN947)
include_if_use(driver_dac14.MCXN947)
include_if_use(driver_dac_1.MCXN947)
include_if_use(driver_dbi.MCXN947)
include_if_use(driver_dbi_flexio_edma.MCXN947)
include_if_use(driver_dbi_flexio_smartdma.MCXN947)
include_if_use(driver_dialog7212.MCXN947)
include_if_use(driver_edma4.MCXN947)
include_if_use(driver_edma_soc.MCXN947)
include_if_use(driver_eim.MCXN947)
include_if_use(driver_enc.MCXN947)
include_if_use(driver_erm.MCXN947)
include_if_use(driver_evtg.MCXN947)
include_if_use(driver_ewm.MCXN947)
include_if_use(driver_flashiap.MCXN947)
include_if_use(driver_flexcan.MCXN947)
include_if_use(driver_flexcan_edma.MCXN947)
include_if_use(driver_flexio.MCXN947)
include_if_use(driver_flexio_i2c_master.MCXN947)
include_if_use(driver_flexio_mculcd.MCXN947)
include_if_use(driver_flexio_mculcd_edma.MCXN947)
include_if_use(driver_flexio_mculcd_smartdma.MCXN947)
include_if_use(driver_flexio_spi.MCXN947)
include_if_use(driver_flexio_spi_edma.MCXN947)
include_if_use(driver_flexio_uart.MCXN947)
include_if_use(driver_flexio_uart_edma.MCXN947)
include_if_use(driver_flexspi.MCXN947)
include_if_use(driver_flexspi_dma3.MCXN947)
include_if_use(driver_ft5406.MCXN947)
include_if_use(driver_ft5406_rt.MCXN947)
include_if_use(driver_ft6x06.MCXN947)
include_if_use(driver_fxos8700cq.MCXN947)
include_if_use(driver_gdet.MCXN947)
include_if_use(driver_gpio.MCXN947)
include_if_use(driver_gt911.MCXN947)
include_if_use(driver_i3c.MCXN947)
include_if_use(driver_i3c_edma.MCXN947)
include_if_use(driver_ili9341.MCXN947)
include_if_use(driver_inputmux.MCXN947)
include_if_use(driver_inputmux_connections.MCXN947)
include_if_use(driver_intm.MCXN947)
include_if_use(driver_irtc.MCXN947)
include_if_use(driver_itrc.MCXN947)
include_if_use(driver_lpadc.MCXN947)
include_if_use(driver_lpc_freqme.MCXN947)
include_if_use(driver_lpc_smartdma.MCXN947)
include_if_use(driver_lpcmp.MCXN947)
include_if_use(driver_lpflexcomm.MCXN947)
include_if_use(driver_lpflexcomm_lpi2c_freertos.MCXN947)
include_if_use(driver_lpflexcomm_lpspi_freertos.MCXN947)
include_if_use(driver_lpflexcomm_lpuart_freertos.MCXN947)
include_if_use(driver_lpi2c.MCXN947)
include_if_use(driver_lpi2c_edma.MCXN947)
include_if_use(driver_lpspi.MCXN947)
include_if_use(driver_lpspi_edma.MCXN947)
include_if_use(driver_lptmr.MCXN947)
include_if_use(driver_lpuart.MCXN947)
include_if_use(driver_lpuart_edma.MCXN947)
include_if_use(driver_mailbox.MCXN947)
include_if_use(driver_mcx_cmc.MCXN947)
include_if_use(driver_mcx_enet.MCXN947)
include_if_use(driver_mcx_spc.MCXN947)
include_if_use(driver_mcx_vbat.MCXN947)
include_if_use(driver_mem_interface.MCXN947)
include_if_use(driver_mma8451q.MCXN947)
include_if_use(driver_mma8652fc.MCXN947)
include_if_use(driver_mrt.MCXN947)
include_if_use(driver_mx25r_flash.MCXN947)
include_if_use(driver_nand_flash-common.MCXN947)
include_if_use(driver_nand_flash-controller-flexspi.MCXN947)
include_if_use(driver_nor_flash-common.MCXN947)
include_if_use(driver_nor_flash-controller-flexspi.MCXN947)
include_if_use(driver_nor_flash-controller-lpspi.MCXN947)
include_if_use(driver_opamp.MCXN947)
include_if_use(driver_ostimer.MCXN947)
include_if_use(driver_p3t1755.MCXN947)
include_if_use(driver_pdm.MCXN947)
include_if_use(driver_pdm_edma.MCXN947)
include_if_use(driver_pf1550.MCXN947)
include_if_use(driver_pf3000.MCXN947)
include_if_use(driver_phy-common.MCXN947)
include_if_use(driver_phy-device-ar8031.MCXN947)
include_if_use(driver_phy-device-dp83848.MCXN947)
include_if_use(driver_phy-device-ksz8041.MCXN947)
include_if_use(driver_phy-device-ksz8081.MCXN947)
include_if_use(driver_phy-device-lan8720a.MCXN947)
include_if_use(driver_phy-device-lan8741.MCXN947)
include_if_use(driver_phy-device-rtl8201.MCXN947)
include_if_use(driver_phy-device-rtl8211f.MCXN947)
include_if_use(driver_phy-device-vsc8541.MCXN947)
include_if_use(driver_pint.MCXN947)
include_if_use(driver_plu.MCXN947)
include_if_use(driver_port.MCXN947)
include_if_use(driver_power.MCXN947)
include_if_use(driver_powerquad.MCXN947)
include_if_use(driver_powerquad_cmsis.MCXN947)
include_if_use(driver_puf_v3.MCXN947)
include_if_use(driver_pwm.MCXN947)
include_if_use(driver_reset.MCXN947)
include_if_use(driver_rtt.MCXN947)
include_if_use(driver_rtt_template.MCXN947)
include_if_use(driver_runbootloader.MCXN947)
include_if_use(driver_sai.MCXN947)
include_if_use(driver_sai_edma.MCXN947)
include_if_use(driver_sctimer.MCXN947)
include_if_use(driver_sgtl5000.MCXN947)
include_if_use(driver_sinc.MCXN947)
include_if_use(driver_smartcard_emvsim.MCXN947)
include_if_use(driver_smartcard_phy_emvsim.MCXN947)
include_if_use(driver_ssd1963.MCXN947)
include_if_use(driver_st7796s.MCXN947)
include_if_use(driver_syspm.MCXN947)
include_if_use(driver_tdet.MCXN947)
include_if_use(driver_trdc_1.MCXN947)
include_if_use(driver_trdc_soc.MCXN947)
include_if_use(driver_tsi_v6.MCXN947)
include_if_use(driver_usdhc.MCXN947)
include_if_use(driver_utick.MCXN947)
include_if_use(driver_video-common.MCXN947)
include_if_use(driver_vref_1.MCXN947)
include_if_use(driver_wm8904.MCXN947)
include_if_use(driver_wm8960.MCXN947)
include_if_use(driver_wuu.MCXN947)
include_if_use(driver_wwdt.MCXN947)
...
include_if_use(middleware_baremetal.MCXN947)
...
include_if_use(middleware_edgefast_bluetooth_mcux_linker_template_mcxn9xxevk)
...
include_if_use(middleware_edgefast_bluetooth_sdio_template_mcxn9xxevk)
...
include_if_use(middleware_issdk_drivers_gpio_mcx)
...
include_if_use(middleware_lwip_mcx_ethernetif)
...
include_if_use(middleware_mbedtls_port_els)
include_if_use(middleware_mbedtls_port_els_pkc)
...
include_if_use(middleware_motor_control_mc_drivers_adcncxn_pwma_enc)
...
include_if_use(middleware_multicore_mcmgr_mcxnx4x)
...
include_if_use(middleware_multicore_rpmsg_lite_bm_config_mcxnx4x)
include_if_use(middleware_multicore_rpmsg_lite_freertos)
include_if_use(middleware_multicore_rpmsg_lite_freertos_config_mcxnx4x)
include_if_use(middleware_multicore_rpmsg_lite_mcxnx4x_bm)
include_if_use(middleware_multicore_rpmsg_lite_mcxnx4x_freertos)
...
include_if_use(utilities_misc_utilities.MCXN947)
include_if_use(utilities_unity.MCXN947)
include_if_use(utility_assert.MCXN947)
include_if_use(utility_assert_lite.MCXN947)
include_if_use(utility_debug_console.MCXN947)
include_if_use(utility_debug_console_lite.MCXN947)
include_if_use(utility_incbin.MCXN947)
include_if_use(utility_notifier.MCXN947)
include_if_use(utility_shell.MCXN947)
include_if_use(utility_str.MCXN947)
