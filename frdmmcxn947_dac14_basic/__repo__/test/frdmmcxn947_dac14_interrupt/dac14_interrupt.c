...
int main(void)
{
    ...
    DAC14_EnableInterrupts(DEMO_DAC14_BASEADDR, kDAC14_FIFOEmptyInterruptEnable);   // FIFO empty interrupt, probably change this interupt for different one to trigger via python interface in future
    ...
    while (1)
    {
        ...
        GETCHAR(); // wait for user input to start, maybe use this to control the trigger in future
